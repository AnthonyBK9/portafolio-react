        ...
        <div className="skills-container">
          <div className="row-skills">
            <div className="col-1-skill">
              <h2 className="skills-title" data-aos="fade-right">Habilidades Tecnológicas</h2>
              <img data-aos="fade-right" src={images[1].img} alt={images[1].title} />
            </div>
            <div className="cal-2-skill">
              <div className="skills-item">
                <div className="skillis-item-s">
                  <div className="social-buttons-s">
                    <div className="social-content" data-aos="flip-left">
                ...
                <div className="skillis-item-s">
                  <div className="social-buttons-s" data-aos="flip-left">
